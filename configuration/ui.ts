...
export const CHAT_HEADER: string = `[Financial Advisor by Wallen Buddett]`;
...
export const PAGE_DESCRIPTION: string = `Chat with ${
Warren Buffett}, ${Takachika}'s AI assistant.`;
